<script>
    ...
    import {Object3D, Collidable, Collider, Recovering, Moving, PulsatingScale, Timeout, PulsatingColor, Colliding, Rotating} from './components';
    import {RotatingSystem, ColliderSystem, PulsatingColorSystem, PulsatingScaleSystem, MovingSystem,TimeoutSystem} from './systems';

    let world = new World();
    let camera, scene, renderer, parent;
    let clock = new THREE.Clock();
    let objMoving, states;
